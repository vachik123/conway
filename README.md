...
Additionally, I've implemented a reset button so one could see the data populate from scratch.

For extra polish, I used Conway's font to experiment with the design language, and see what interfaces could be easily imagined in Conway's work.

I've used Claude Code to assist with this project.
